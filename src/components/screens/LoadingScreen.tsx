  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center px-4">
        ...
        {/* Progress bar */}
        <div className="w-40 sm:w-48 h-2 bg-white/20 rounded-full overflow-hidden">
          <div 
        ...
        {/* Tip */}
        <p className="mt-4 sm:mt-6 text-white/50 text-xs sm:text-sm text-center max-w-xs px-2">
